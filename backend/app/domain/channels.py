...
Ported near-verbatim from powerwave's app/models/channels.py (commit
3156392). Channels never carry sample data -- that lives only in
DisturbanceRecord.waveform_data, keyed by channel name.
"""
